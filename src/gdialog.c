...
GDIALOG_METHOD(__construct){
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "|Szlz", &title, &parent, &flags, &array) == FAILURE) {
...
zend_declare_class_constant_double(gdialog_class_entry_ce, name, sizeof(name)-1, value);

void gdialog_init(int module_number){
	DECLARE_CLASS_PROPERTY_INIT();
	le_gdialog = zend_register_list_destructors_ex(gwidget_free_resource, NULL, "gdialog", module_number);
	...
	INIT_CLASS_ENTRY(ce, "GDialog", gdialog_class_functions);
	...
	GDIALOG_CONSTANT("GDIALOG_FLAG_MODAL"					,GDIALOG_FLAG_MODAL					);
	GDIALOG_CONSTANT("GDIALOG_FLAG_DESTROY_WITH_PARENT"		,GDIALOG_FLAG_DESTROY_WITH_PARENT	);
	GDIALOG_CONSTANT("GDIALOG_FLAG_USE_HEADER_BAR"			,GDIALOG_FLAG_USE_HEADER_BAR		);

	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_NONE"			,GDIALOG_RESPONSE_TYPE_NONE			);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_REJECT"			,GDIALOG_RESPONSE_TYPE_REJECT		);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_ACCEPT"			,GDIALOG_RESPONSE_TYPE_ACCEPT		);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_DELETE_EVENT"	,GDIALOG_RESPONSE_TYPE_DELETE_EVENT	);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_OK"				,GDIALOG_RESPONSE_TYPE_OK			);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_CANCEL"			,GDIALOG_RESPONSE_TYPE_CANCEL		);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_CLOSE"			,GDIALOG_RESPONSE_TYPE_CLOSE		);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_YES"			,GDIALOG_RESPONSE_TYPE_YES			);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_NO"				,GDIALOG_RESPONSE_TYPE_NO			);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_APPLY"			,GDIALOG_RESPONSE_TYPE_APPLY		);
	GDIALOG_CONSTANT("GDIALOG_RESPONSE_TYPE_HELP"			,GDIALOG_RESPONSE_TYPE_HELP			);
}
