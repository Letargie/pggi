...
static const zend_function_entry gtext_buffer_class_functions[] = {
	...
	PHP_ME(GTextBuffer, getLineCount, arginfo_pggi_void	, ZEND_ACC_PUBLIC)
	PHP_ME(GTextBuffer, getCharCount, arginfo_pggi_void	, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
void gtext_buffer_init(int module_number){
	zend_class_entry ce;
	le_gtext_buffer = zend_register_list_destructors_ex(gtext_buffer_free_resource, NULL, "gtext_buffer", module_number);
	...
	INIT_CLASS_ENTRY(ce, "GTextBuffer", gtext_buffer_class_functions);
