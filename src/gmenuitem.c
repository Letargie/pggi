...
static const zend_function_entry gmenuitem_class_functions[] = {
	PHP_ME(GMenuItem, __construct	, arginfo_pggi_void	, ZEND_ACC_PUBLIC | ZEND_ACC_CTOR	)
...
void gmenuitem_init(int module_number){
	...
	le_gmenuitem = zend_register_list_destructors_ex(gwidget_free_resource, NULL, "gmenuitem", module_number);
	...
	INIT_CLASS_ENTRY(ce, "GMenuItem", gmenuitem_class_functions);
